![docker image](https://github.com/mariadinkova/Nomad-test/actions/workflows/docker-publish.yml/badge.svg)


# mariadinkova's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mariadinkova.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mariadinkova/Nomad-test.git
    cd Nomad-test
    ```
    ...
    ```sh
    curl-L -o Nomad-test.zip "https://github.com/mariadinkova/Nomad-test/archive/main.zip"
    unzip Nomad-test.zip
    cd Nomad-test
    ```
...
your `docker-compose.yaml` with `ghcr.io/mariadinkova/nomad-test:main` for the services
...
```sh
docker pull ghcr.io/mariadinkova/nomad-test/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/mariadinkova/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/mariadinkova/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mariadinkova/Nomad-test/manifests/main": unauthorized`
